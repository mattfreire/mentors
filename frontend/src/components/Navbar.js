                  ...
                  {user ? (
                    ...
                    <div>
                      <Menu.Button
                        ...
                        <img className="rounded-full h-8 w-8" src={user.profile_picture ? user.profile_picture : `https://avatars.dicebear.com/api/initials/${user.name}.svg`} alt=""/>
                      </Menu.Button>
                    </div>
                    <Transition
                      as={Fragment}
            ...
            <div className="pt-4 pb-3 border-t border-gray-200">
              {user ? (
                <div className="px-5 flex items-center">
                  <div className="flex-shrink-0">
                    <img className="rounded-full h-10 w-10" src={user.profile_picture ? user.profile_picture : `https://avatars.dicebear.com/api/initials/${user.name}.svg`} alt=""/>
                  </div>
                  <div className="ml-3">
